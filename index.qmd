...
|  Nov 20 | High dimensional data| [Intro to Linear Algebra](slides/highdim/32-linear-algebra-intro.qmd), [Matrices in R](slides/highdim/33-matrices-in-R.qmd) | [Matrices in R](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/matrices-in-R.html), [Applied Linear Algebra](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/linear-algebra.html), [Dimension Reduction](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/dimension-reduction.html) |
