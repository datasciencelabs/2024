...
* Lecture slides, class notes, and problem sets are linked in the schedules below.
...
We thank [Maria Tackett](https://github.com/matackett) and [Mine Cetinkaya-Rundel](https://github.com/mine-cetinkaya-rundel) for sharing their [web page template](https://github.com/rstudio-conf-2022/teach-ds-course-website/tree/main), which we used in creating this website.
