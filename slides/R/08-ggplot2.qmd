...
* Layers can define trasnformations:
...
* Note that a legend was created automatically!

* This is how we change the name of the legend:
...
* Add a line with the `geom_abline` function:
...
* Here is `theme_fivethirtyeight()` theme
